  ...
  sidebarInner.innerHTML = `
    ...
    <div class="sidebar-list">
      ...
      <a href="./movie-list.html" menu-close class="sidebar-link"
        onclick='getMovieList("with_original_language=en", "Indonesia")'>Indonesia</a>
      <a href="./movie-list.html" menu-close class="sidebar-link"
        onclick='getMovieList("with_original_language=en", "English")'>English</a>
      <a href="./movie-list.html" menu-close class="sidebar-link"
        onclick='getMovieList("with_original_language=ko", "Korea")'>Korea</a>
      <a href="./movie-list.html" menu-close class="sidebar-link"
    ...
    <div class="sidebar-footer">
      <p class="copyright">
        Copyright 2023
        <a href="www.garry.com" target="_blank">rhmn rmd</a>
      </p>
